...
func TestSummarizeEntries(t *testing.T) {
	...
	summary := SummarizeEntries([]Entry{
		...
		{Lemma: "budget", Pos: "noun", MeaningJA: "予算", Level: "toeic800", FrequencyRank: 200, DistractorGroup: "business-noun"},
		{Lemma: "calm", Pos: "adjective", MeaningJA: "落ち着いた", Level: "toeic600", DistractorGroup: "emotion-adjective"},
	})
