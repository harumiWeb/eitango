...
func (m RootModel) renderSettingsOverlay() string {
	lines := []string{
		...
		m.renderSettingsRow(1, i18n.T(i18n.SettingsWriteDifficulty), m.settingsWriteDifficultyLabel()),
		m.renderSettingsRow(2, i18n.T(i18n.SettingsLanguage), m.settingsLanguageLabel()),
		"",
