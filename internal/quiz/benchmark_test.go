...
func BenchmarkBuildChoices(b *testing.B) {
	...
	pool := []store.Word{
		...
		{ID: 6, Lemma: "delegate", Pos: "verb", MeaningJA: "委任する", Level: "core-3", FrequencyRank: 5200, DistractorGroup: "business-verb"},
		{ID: 7, Lemma: "expand", Pos: "verb", MeaningJA: "拡大する", Level: "core-3", FrequencyRank: 6500, DistractorGroup: "change-verb"},
	}
