...
<div align="center" style="max-width: 600px; margin: auto;">
  ...
  ![GitHub Release](https://img.shields.io/github/v/release/harumiWeb/eitango) ![WinGet Package Version](https://img.shields.io/winget/v/HarumiWeb.Eitango) ![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/harumiWeb/eitango/total)
...
The embedded vocabulary currently contains about **10000** words, and external dictionary import from CSV / JSONL is also supported. The tool includes learning statistics, progress management, update notifications, and diagnostic tools.
